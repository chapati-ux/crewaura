    ...
    >
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        <div ref={ringRef} className="opacity-0">
          <FaRing className="mx-auto mb-6" size={32} style={{ color: '#C8A96A' }} />
        </div>
        ...
        <div ref={textRef}>
          ...
          <h1
            ...
            style={{ color: '#1A1A1A', fontFamily: "'Playfair Display', serif" }} // Dark elegant contrast text
          >
          ...
          >
            For over a decade, Crew Aura has turned unique love stories into unforgettable 
            destination celebrations. From quiet beachside vows to grand ballroom affairs across 
            Navi Mumbai and pan-India destinations, our team manages meticulous operational execution 
            so you can simply remain fully present in your own magical moment.
          </p>
        </div>
      </div>
    </main>
